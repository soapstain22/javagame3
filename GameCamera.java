...
public class GameCamera extends Panel {
    ...
    public void paint(Graphics g) {
        ...
        g.drawString(Game.player.direction + "d " + Game.player.headType + "h " + Game.player.bodyType + "b "
                + Game.player.legsType + "l ", 120, 40);
         ...
         * g.drawImage(go[j],(int)Game.gameMap.objex[i].x,(int)Game.gameMap.objex[i].y,
         * this);
         * }
         * }
         */
